...
using BTreeOMLVarLen = ::dbgroup::index::b_tree::BTreeOMLVarLen<K, V, C>;

using TestTargets = ::testing::Types<              //
    IndexInfo<BTreeOMLVarLen, UInt8, UInt8>,       // fixed-length keys
    IndexInfo<BTreeOMLVarLen, UInt4, UInt8>,       // small keys
